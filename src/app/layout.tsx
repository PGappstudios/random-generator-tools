    ...
    <html lang="en">
      ...
      <body className={`${inter.className} bg-gradient-to-br from-blue-50 via-violet-50 to-purple-50`}>
        <main className="min-h-screen">
          ...
          <section className="py-16 bg-gradient-to-br from-white via-blue-50/30 to-violet-50/30">
          ...
          <section className="max-w-4xl mx-auto px-4 py-12 mt-12 border-t border-gray-100">
            ...
            <div className="space-y-6" itemScope itemType="https://schema.org/FAQPage">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">How does the Random Number Generator work?</h3>
              ...
              {/* Dice Roller FAQ */}
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">What types of dice can I roll?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text" className="text-gray-600">
              ...
              {/* Random Wheel FAQ */}
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">How can I use the Random Wheel Spinner?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text" className="text-gray-600">
              ...
              {/* Random List FAQ */}
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">Can I import items from Excel for the Random List Picker?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text" className="text-gray-600">
              ...
              {/* General Usage FAQ */}
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">Are these random generators truly random?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text" className="text-gray-600">
              ...
              {/* Mobile Usage FAQ */}
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg shadow-sm p-6">
                <h3 itemProp="name" className="text-xl font-semibold text-indigo-600 mb-3">Can I use these tools on mobile devices?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text" className="text-gray-600">
